 ...
 */
@WebServlet({"/sampleCicsCallEjbServletWithRollback"})
@Transactional
public class SampleCicsCallEjbServletWithRollback extends HttpServlet {

  private static final Logger logger = LoggerFactory.getLogger(SampleCicsCallEjbServletWithRollback.class);
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    throw new EJBTransactionRolledbackException("Transaction forcibly rolled back by the calling servlet");
  }
}
