 ...
 */
@WebServlet({"/sampleCicsCallEjbServletWithoutTx"})
public class SampleCicsCallEjbServletWithoutTx extends HttpServlet {

  private static final Logger logger = LoggerFactory.getLogger(SampleCicsCallEjbServletWithoutTx.class);
