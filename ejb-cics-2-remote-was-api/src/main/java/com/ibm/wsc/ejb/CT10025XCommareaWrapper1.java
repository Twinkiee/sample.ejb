...
// Generated by com.ibm.jzos.recordgen.cobol.RecordClassGenerator on Mon Feb 10 10:55:38 CET 2020

public class CT10025XCommareaWrapper1 {
	protected static CobolDatatypeFactory factory = new CobolDatatypeFactory();
	static { factory.setStringTrimDefault(false); } 

	/** <pre>
	 01 INPUT-CT10025X. </pre> */
	public static final int INPUT_CT10025X_len = 294; 
...
//	protected static final StringField WLXAXMLP_ABI_ISTITUTO_In_WLXAXMLP_DATI_ISTITUTO = factory.getStringField(5);
	...
	*AREA DATI *****************************************************
	...
	/** <pre>
	   03  RES-MEN-CT1025I. </pre> */
	public static final int RES_MEN_CT1025I_len = 11; 
	public static final int RES_MEN_CT1025I_offset = factory.getOffset();
...
//	protected String wlxaxmlpAbiIstituto_In_wlxaxmlpDatiIstituto;
	...
	public CT10025XCommareaWrapper1 (byte[] buffer) {
		this._byteBuffer = buffer;
	}

	public CT10025XCommareaWrapper1 () {
		this._byteBuffer = new byte[INPUT_CT10025X_len];
	}
