...
import com.sample.ejb.bean.WOXABC40CommareaWrapper1;
...
public class WOXABC40CommareaWrapper1Handler implements CicsCommunicationHandler {
  ...
  public CicsObjectWrapper getWrapperInstance(String input) throws JsonProcessingException {
    ...
    wrapper.setWlxaxmlpAbiIstituto(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpAbiIstituto", String.class));
    wrapper.setWlxaxmlpCab(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpCab", String.class));
    wrapper.setWlxaxmlpCabCont(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpCabCont", String.class));
    wrapper.setWlxaxmlpCanale(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpCanale", String.class));
    wrapper.setWlxaxmlpDat(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpDat", Integer.class));
    wrapper.setWlxaxmlpDatContabile(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpDatContabile", Integer.class));
    wrapper.setWlxaxmlpDescrizione(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpDescrizione", String.class));
    wrapper.setWlxaxmlpEnte(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpEnte", String.class));
    wrapper.setWlxaxmlpEnteCont(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpEnteCont", String.class));
    wrapper.setWlxaxmlpIstituto(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpIstituto", String.class));
    wrapper.setWlxaxmlpOpe(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpOpe", String.class));
    wrapper.setWlxaxmlpOra(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpOra", Integer.class));
    wrapper
        .setWlxaxmlpProcedura(
            commareaWrapperHelper.getValue(inputMap, "wlxaxmlpProcedura", String.class));
    wrapper
        .setWlxaxmlpProgramma(
            commareaWrapperHelper.getValue(inputMap, "wlxaxmlpProgramma", String.class));
    wrapper.setWlxaxmlpReasonCode(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpReasonCode", String.class));
    wrapper.setWlxaxmlpReturnCode(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpReturnCode", String.class));
    wrapper.setWlxaxmlpSessionHandle(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpSessionHandle", String.class));
    wrapper.setWlxaxmlpSezione(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpSezione", String.class));
    wrapper.setWlxaxmlpSubEnte(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpSubEnte", String.class));
    wrapper.setWlxaxmlpSubEnteCont(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpSubEnteCont", String.class));
    wrapper
        .setWlxaxmlpSysid(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpSysid", String.class));
    wrapper.setWlxaxmlpTerm(commareaWrapperHelper.getValue(inputMap, "wlxaxmlpTerm", String.class));
    wrapper.setWlxaxmlpTipEnte(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpTipEnte", String.class));
    wrapper.setWlxaxmlpTipEnteCont(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpTipEnteCont", String.class));
    wrapper.setWlxaxmlpTransazione(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpTransazione", String.class));
    wrapper.setWlxaxmlpUfficio(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpUfficio", String.class));
    wrapper.setWoxabc40CatSecOldI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40CatSecOldI", String.class));
    wrapper.setWoxabc40CodiceI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40CodiceI", String.class));
    wrapper.setWoxabc40CodTipExpeI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40CodTipExpeI", String.class));
    wrapper
        .setWoxabc40DataAperO(
            commareaWrapperHelper.getValue(inputMap, "woxabc40DataAperO", Integer.class));
    wrapper
        .setWoxabc40DataEstO(
            commareaWrapperHelper.getValue(inputMap, "woxabc40DataEstO", Integer.class));
    wrapper
        .setWoxabc40DataO(commareaWrapperHelper.getValue(inputMap, "woxabc40DataO", Integer.class));
    wrapper.setWoxabc40DisponibilitaO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40DisponibilitaO", BigDecimal.class));
    wrapper
        .setWoxabc40DvCodiceO(
            commareaWrapperHelper.getValue(inputMap, "woxabc40DvCodiceO", String.class));
    wrapper.setWoxabc40FidoAssO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40FidoAssO", BigDecimal.class));
    wrapper.setWoxabc40FidoCassaO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40FidoCassaO", BigDecimal.class));
    wrapper.setWoxabc40FidoPromiscuoO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40FidoPromiscuoO", BigDecimal.class));
    wrapper.setWoxabc40FidoSbfO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40FidoSbfO", BigDecimal.class));
    wrapper.setWoxabc40FilSecOldI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40FilSecOldI", String.class));
    wrapper.setWoxabc40IntestazioneO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40IntestazioneO", String.class));
    wrapper.setWoxabc40NumAccordoI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40NumAccordoI", Long.class));

    final Integer woxabc40NumCtaIntI = commareaWrapperHelper
        .getValue(inputMap, "woxabc40NumCtaIntI", Integer.class);
    logger.debug("Setting Woxabc40NumCtaIntI with value [ {} ]", woxabc40NumCtaIntI);

    wrapper.setWoxabc40NumCtaIntI(woxabc40NumCtaIntI);
    wrapper
        .setWoxabc40OraO(commareaWrapperHelper.getValue(inputMap, "woxabc40OraO", Integer.class));
    wrapper.setWoxabc40PartAvvAvereO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40PartAvvAvereO", BigDecimal.class));
    wrapper.setWoxabc40PartAvvDareO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40PartAvvDareO", BigDecimal.class));
    wrapper.setWoxabc40PartIndAltO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40PartIndAltO", BigDecimal.class));
    wrapper.setWoxabc40PartIndAssO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40PartIndAssO", BigDecimal.class));
    wrapper.setWoxabc40SalContO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40SalContO", BigDecimal.class));
    wrapper.setWoxabc40SalDispO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40SalDispO", BigDecimal.class));
    wrapper.setWoxabc40SalLiquidoO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40SalLiquidoO", BigDecimal.class));
    wrapper.setWoxabc40SalPartIndiO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40SalPartIndiO", BigDecimal.class));
    wrapper.setWoxabc40SrvSecOldI(
        commareaWrapperHelper.getValue(inputMap, "woxabc40SrvSecOldI", String.class));
    wrapper
        .setWoxabc40StatoConO(
            commareaWrapperHelper.getValue(inputMap, "woxabc40StatoConO", String.class));
    wrapper.setWoxabc40ValoreO(
        commareaWrapperHelper.getValue(inputMap, "woxabc40ValoreO", Integer.class));
