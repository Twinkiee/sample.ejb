...
public class CT30X015CommareaWrapper1Handler implements CicsCommunicationHandler {
  ...
  public CicsObjectWrapper getWrapperInstance(String input) throws JsonProcessingException {
    ...
    wrapper.setWlxaxmlpCabCont(
        commareaWrapperHelper.getValue(inputMap, "wlxaxmlpabCont", String.class));
    ...
    wrapper.setCt30x015AccSrvI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015AccSrvI", String.class));
    wrapper.setCt30x015CentroI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CentroI", String.class));
    wrapper.setCt30x015CmTotaleEuroI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CmTotaleEuroI", BigDecimal.class));
    wrapper.setCt30x015CodCanaleI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodCanaleI", String.class));
    wrapper.setCt30x015CodcatsecI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodcatsecI", Integer.class));
    wrapper.setCt30x015CodErrO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodErrO", Integer.class));
    wrapper.setCt30x015CodfilsecI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodfilsecI", Integer.class));
    wrapper.setCt30x015CodOperacionI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodOperacionI", String.class));
    wrapper.setCt30x015CodProcOrigI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodProcOrigI", String.class));
    ...
    wrapper.setCt30x015CodsrvsecI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodsrvsecI", Integer.class));
    wrapper.setCt30x015CodTipExpeI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015CodTipExpeI", String.class));
    wrapper.setCt30x015DescErroreO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015DescErroreO", String.class));
    wrapper.setCt30x015DominioI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015DominioI", String.class));
    ...
    wrapper.setCt30x015IsTotaleEuroO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015IsTotaleEuroO", BigDecimal.class));
    wrapper.setCt30x015NodoI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NodoI ", String.class));
    wrapper.setCt30x015NumCtaIntI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NumCtaIntI", Integer.class));
    wrapper.setCt30x015NumMessaggioI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NumMessaggioI", Integer.class));
    wrapper.setCt30x015NumOperacionO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NumOperacionO", Long.class));
    wrapper.setCt30x015NumpartsecI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NumpartsecI", Integer.class));
    wrapper.setCt30x015NumUtlMovO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015NumUtlMovO", Integer.class));
    wrapper.setCt30x015PostazioneI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015PostazioneI", Integer.class));
    wrapper.setCt30x015ScTotaleEuroO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015ScTotaleEuroO", BigDecimal.class));
    wrapper.setCt30x015SnTotaleEuroO(
        commareaWrapperHelper.getValue(inputMap, "ct30x015SnTotaleEuroO", BigDecimal.class));
    wrapper.setCt30x015SpTotaleEuroI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015SpTotaleEuroI", BigDecimal.class));
    wrapper.setCt30x015SrTotaleEuroI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015SrTotaleEuroI", BigDecimal.class));
    wrapper.setCt30x015TotaleEuroI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015TotaleEuroI", BigDecimal.class));
    wrapper.setCt30x015TxtMovimentoI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015TxtMovimentoI", String.class));
    wrapper.setCt30x015ValoreI(
        commareaWrapperHelper.getValue(inputMap, "ct30x015ValoreI", Integer.class));

    try {
      logger.info("Generated wrapper [ {} ];\nbyte array [ {} ]", wrapper,
          new String(wrapper.getByteBuffer(),
              "Cp1047"));
